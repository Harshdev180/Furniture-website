    ...
    <section className="w-full">
      <div className="relative h-[70vh] flex items-center justify-center text-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
          <h1 className="text-5xl font-bold mb-4 font-serif text-[#C9A24D]">
            Contact Us
          </h1>
          <p className="max-w-2xl sm:text-lg text-[14px] leading-relaxed text-white">
            We're here to help you create your dream space. Reach out for
            inquiries, consultations, or just to say hello.
          </p>
        </div>
      </div>
