        ...
        <div className="relative overflow-hidden rounded-3xl mb-6 min-h-[300px] md:min-h-[420px]">
          ...
          <div className="relative z-10 px-4 sm:px-6 py-12 md:py-20">
            ...
            <p className="text-[#F5E6C8] max-w-2xl mx-auto mt-4 text-sm sm:text-base">
              At Graphura Interiors, we believe in transparency and providing
              you with a seamless, personalized shopping experience.
            </p>
              ...
              {sections.map((item, index) => (
                <li key={item.id}>
                  <a
                    href={`#${item.id}`}
                    data-id={item.id}
                    className="toc-link block hover:text-[#C9A24D] transition"
                  >
                    {index + 1}. {item.label}
                  </a>
                </li>
        ...
        <main className="lg:col-span-3 space-y-14 px-4 sm:px-6 md:px-8">
          <section id="what-are-cookies" className="scroll-mt-32">
            ...
            <p className="leading-relaxed">
              ...
              you visit our website. They act as a memory for the website,
              allowing it to recognize you and your preferences on future
              visits. We use cookies to ensure our website functions correctly,
              to understand how visitors interact with our content, and to
              deliver personalized marketing that aligns with your refined
              tastes.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-[#F5E6C8] max-w-lg mx-auto mb-6 text-sm sm:text-base">
              Graphura value your trust above all else. If you have any
              questions regarding this policy or how we handle your data, please
