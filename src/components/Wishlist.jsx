...
const Wishlist = () => {
  ...
  if (wishlist.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-4 bg-[#FAF7F2]">
        ...
        <p className="text-[#3E2723]/60 mt-2 max-w-md">
          Save your favorite furniture pieces here and come back anytime to buy
          them.
        </p>
