...
const Inspiration = () => {
  ...
  const bedProduct = {
    ...
    price: 5400,
    image:
      "https://img.freepik.com/premium-photo/bed-with-white-headboard-brown-gray-comforter_520665-30664.jpg",
  ...
  const sofaProduct = {
    ...
    price: 6100,
    image:
      "https://img.freepik.com/free-photo/modern-fashionable-red-leather-couch-with-cushions-cropped-christmas-tree-brick-wall-loft-design_132075-11381.jpg",
    ...
    <section>
      <div className="mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
          <div>
            ...
            <p className="mt-2 text-[#2B2B2B]/70 max-w-xl">
              Explore featured furniture templates with pre-selected furniture
              sets.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* CARD 1 */}
          <Link
            to={`/product/${bedProduct.id}`}
            state={{ product: bedProduct }}
            className="group"
          >
          ...
          {/* CARD 2 */}
          <Link
            to={`/product/${sofaProduct.id}`}
            state={{ product: sofaProduct }}
            className="group"
          >
            <div className="rounded-2xl overflow-hidden aspect-video mb-5 relative shadow-soft border border-[#E6D5C3]/30">
              <Picture
